...
void autonomous(void) {
  BackRightWheel.setVelocity(100, percent); //setting speed of back right wheel
  FrontRightWheel.setVelocity(100, percent); //setting speed of front right wheel
  BackLeftWheel.setVelocity(100, percent); //setting speed of back left wheel
  FrontLeftWheel.setVelocity(100, percent); //setting speed of front left wheel
  BackLeftWheel.startSpinFor(forward, 1000, degrees);
  BackRightWheel.startSpinFor(forward, 1000, degrees);
  FrontRightWheel.startSpinFor(forward, 1000, degrees);
  FrontLeftWheel.spinFor(forward, 1000, degrees);
